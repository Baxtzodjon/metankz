        ...
        <section className="bg-light pt-[120px] pb-[60px]">
            ...
            <div className="container">
                ...
                >
                    ...
                    <video ref={videoRef} className="w-full h-full object-cover" src="/videos/about_video.mp4" loop controls={isPlaying} preload="metadata" poster="/images/poster.png" onPause={() => setIsPlaying(false)} onPlay={() => setIsPlaying(true)}></video>
