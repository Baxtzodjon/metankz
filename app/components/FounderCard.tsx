...
const FounderCard = () => {
    return (
        <section className="relative overflow-hidden bg-light before:content-[''] before:absolute before:-right-[200px] before:w-[570px] before:h-[1065px] before:bg-[url('/images/facts_bg.png')] before:bg-center before:bg-no-repeat before:bg-cover">
            ...
            <div className="container relative mt-0 sm:mt-10 lg:mt-[120px] mb-[120px] flex flex-col gap-5">
                ...
                <div className="w-full lg:w-[560px] xl:w-[735px] bg-light flex lg:items-start justify-center flex-col gap-[51px] shadow-soft-multi lg:absolute bottom-[100px] py-10 lg:py-[50px] lg:right-[15px] xl:right-0 px-3 lg:pl-3 xl:pl-[77px] rounded lg:rounded-none">

                    <div className="flex gap-2 lg:gap-2 xl:gap-[30px]">

                        <svg width="28" height="20" viewBox="0 0 28 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[56px] hidden lg:block">
                    ...
                    <div className="flex items-center justify-between gap-0 lg:gap-[180px] pl-0 lg:pl-[60px]">
